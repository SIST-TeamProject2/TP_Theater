...
%>
일반 :<input type="image" src="image/minus.png" onclick="location.href='reservation_af.jsp?general2=<%=general2%>'"><%=general2%><input type="image" src="image/plus.png" onclick="location.href='reservation_af.jsp?general2_p=<%=general2%>'">
청소년 :<input type="image" src="image/minus.png" onclick="location.href='reservation_af.jsp?teen2=<%=teen2%>'"><%=teen2%><input type="image" src="image/plus.png" onclick="location.href='reservation_af.jsp?teen2_p=<%=teen2%>'">
